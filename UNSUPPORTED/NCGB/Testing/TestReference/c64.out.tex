...
\smallskip\\
\rule[3pt]{6in}{.7pt}\\
The expressions with unknown variables $\{Inva\}$\\
...
\end{minipage}\\
\rule[3pt]{6in}{.7pt}\\
The expressions with unknown variables $\{InvAja\}$\\
and knowns $\{a,
$ $
Ajc,
$ $
...
\noindent
The time for preliminaries was 0:00:02\\
The time for NCMakeGB 1 was 0:00:01\\
The time for Remove Redundant 1 was 0:00:00\\
The time for the main NCMakeGB was 0:00:04\\
