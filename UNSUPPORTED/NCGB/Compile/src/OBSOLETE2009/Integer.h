...
extern IntRep*  Ialloc(IntRep*, const unsigned short *, size_t, int, size_t);
extern IntRep*  Icalloc(IntRep*, size_t);
...
extern IntRep*  Iresize(IntRep*, size_t);
...
extern IntRep*  _negate(const IntRep*, IntRep*);
extern IntRep*  pow(const IntRep*, long);
extern IntRep*  gcd(const IntRep*, const IntRep* y);
extern int32_t     compare(const IntRep*, const IntRep*);
extern int32_t     compare(const IntRep*, long);
extern int32_t     ucompare(const IntRep*, const IntRep*);
extern int32_t     ucompare(const IntRep*, long);
...
{
  dest.rep = _negate(x.rep, dest.rep);
}
